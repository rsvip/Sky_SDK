...
class Document extends
    ...
    Picture get rootPicture native "Document_rootPicture_Getter";
    void set rootPicture(Picture value) native "Document_rootPicture_Setter";
    ...
    Text createText(String text) native "Document_createText_Callback";
